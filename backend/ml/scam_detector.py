...
_SYSTEM = (
    ...
    "ALSO (common in rural India): a stuck pension / DBT / subsidy / scholarship / "
    "PM-Kisan / MGNREGA-wage payment that supposedly needs 're-KYC', Aadhaar-seeding, "
    "or an OTP to release; a 'your account/SIM will be blocked today' KYC threat; or "
    "an electricity/utility disconnection threat used to force urgent action.\n"
    ...
    "'move everything', an access/card/SIM reset, to share an OTP/PIN, or to make an "
    "Aadhaar-linked / AePS biometric withdrawal.\n"
